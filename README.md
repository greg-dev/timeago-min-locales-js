...
## Progress
* Refactored files (<!-- replace:miniFilesNum -->16<!-- end:replace:miniFilesNum -->): <!-- replace:miniFiles -->bg, ca, da, de, el, en, en_short, fr, hu, in_ID, ml, pl, ro, ru, th, tr<!-- end:replace:miniFiles -->

* Files to refactor (<!-- replace:todoFilesNum -->21<!-- end:replace:todoFilesNum -->): <!-- replace:todoFiles -->ar, be, es, eu, fi, he, in_BG, in_HI, it, ja, ko, nb_NO, nl, nn_NO, pt_BR, sv, ta, uk, vi, zh_CN, zh_TW<!-- end:replace:todoFiles -->

* Minified size after refactoring: <!-- replace:miniBytes -->21900<!-- end:replace:miniBytes --> bytes (<!-- replace:diffPercent -->80.73<!-- end:replace:diffPercent -->% of original <!-- replace:origBytes -->27129<!-- end:replace:origBytes --> bytes)

* Saved: <!-- replace:diffBytes -->5229<!-- end:replace:diffBytes --> bytes (<!-- replace:savedPercent -->19.27<!-- end:replace:savedPercent -->%)
