...
## Progress
* Refactored files (<!-- replace:miniFilesNum -->30<!-- end:replace:miniFilesNum -->): <!-- replace:miniFiles -->bg, ca, da, de, el, en, en_short, es, eu, fi, fr, he, hu, in_BG, in_HI, in_ID, it, ml, nb_NO, nn_NO, pl, pt_BR, ro, ru, ta, th, tr, vi, zh_CN, zh_TW<!-- end:replace:miniFiles -->

* Files to refactor (<!-- replace:todoFilesNum -->7<!-- end:replace:todoFilesNum -->): <!-- replace:todoFiles -->ar, be, ja, ko, nl, sv, uk<!-- end:replace:todoFiles -->

* Minified size after refactoring: <!-- replace:miniBytes -->18327<!-- end:replace:miniBytes --> bytes (<!-- replace:diffPercent -->67.56<!-- end:replace:diffPercent -->% of original <!-- replace:origBytes -->27129<!-- end:replace:origBytes --> bytes)

* Saved: <!-- replace:diffBytes -->8802<!-- end:replace:diffBytes --> bytes (<!-- replace:savedPercent -->32.44<!-- end:replace:savedPercent -->%)
