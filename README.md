...
* Minified size after refactoring: <!-- replace:miniBytes -->17412<!-- end:replace:miniBytes --> bytes (<!-- replace:diffPercent -->64.18<!-- end:replace:diffPercent -->% of original <!-- replace:origBytes -->27130<!-- end:replace:origBytes --> bytes)

* Saved: <!-- replace:diffBytes -->9718<!-- end:replace:diffBytes --> bytes (<!-- replace:savedPercent -->35.82<!-- end:replace:savedPercent -->%)
